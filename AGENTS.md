...
- Root Python daemons: `grizzl_e_daemon.py`, `tuya_kitchen_bridge.py`, `tuya_listener.py`, `esphome_kitchen_bridge.py`, `update_kitchen_presence.py`, `check_garage_vision.py`
